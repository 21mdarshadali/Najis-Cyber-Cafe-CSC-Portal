...
;
    ...
    function editNotice(id, title, isNew) {
  editingNoticeId = id;

  document.getElementById("notice-title").value = title;
  document.getElementById("notice-is-new").checked = isNew;

  document.querySelector("#notice-form button").innerText = "Update Notice";
}
...
<div class="admin-actions">
  ...
  ">
    ...
    <!-- LEFT : NOTICE TEXT -->
    <div style="flex:1; font-size:14px; font-weight:600;">
      ${n.title}
    ...
    <div style="display:flex; gap:6px;">
      ...
      <button
        onclick="editNotice('${n.id}','${n.title.replace(/'/g, "\\'")}',${n.isNew})"
        style="
          padding:4px 10px;
          font-size:12px;
          border-radius:999px;
...
<div id="notice-board"
  ...
  <div id="notice-list">
    Loading notices...
            ...
            <div style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a6f 100%); border-radius: 12px; padding: 1.5rem; box-shadow: 0 6px 20px rgba(0,0,0,0.2); margin-bottom: 1.5rem; position: relative; overflow: hidden; border: 3px solid rgba(255,255,255,0.3);">
